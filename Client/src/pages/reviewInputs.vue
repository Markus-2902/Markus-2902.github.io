...
const getRandomLastName = () => {
  const lastNames = ['Müller', 'Schmidt', 'Meier', 'Schulz', 'Schneider', 'Fischer', 'Weber'];
...
const purpose = ref('Besuch zur Besprechung von Projektideen und Kooperationen.');
...
<template>
  <div class="min-h-screen bg-gray-100 py-10 px-4">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
      <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Anmeldeformular</h2>
