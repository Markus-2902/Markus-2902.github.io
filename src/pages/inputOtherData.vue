...
<template>
  <div class="min-h-screen bg-gray-100 py-10 px-4">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
      <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Anmeldeformular: Schritt 2</h2>

      <form @submit.prevent="submitForm" class="space-y-6">
        <!-- Zweck -->
        <div>
          <label for="purpose" class="block text-sm font-medium text-gray-700">Zweck</label>
          <textarea
            id="purpose"
            rows="5"
            v-model="purpose"
        ...
        <div class="flex flex-col space-y-4">
          <div class="flex items-center">
            ...
            <label for="dsgvoConfirm" class="ml-2 block text-sm text-gray-900">
              Ich bestätige die
              <a href="https://youtube.com" target="_blank" class="text-indigo-600 underline"
                >DSGVO-Bedingungen</a
              >
            </label>
          </div>
          ...
          <div class="flex items-center">
            <input
              ...
              class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
            />
            <label for="securityBriefConfirm" class="ml-2 block text-sm text-gray-900">
              Ich bestätige die
              <a href="https://youtube.com" target="_blank" class="text-indigo-600 underline"
